    ...
    <div className="divcontainerInfo">
      ...
      <div className="divInfo">
        ...
        <p className="textInfo">
          ...
          estroncio, boro, manganeso, cobre, silicio…
          <br />
          <br />
          Presenta alrededor de 100 elementos biodisponibles de los 118
          elementos de la tabla periódica. La presencia de estos elementos hace
          del agua de mar un excelente recurso para suplir el déficit mineral o
          complementar su aporte a la alimentación habitual.
          <br />
          <br />
          El conocimiento de la terapia con agua de mar se lo debemos al
          científico francés René Quinton (1867-1925), que demostró la similitud
          de la composición del plasma sanguíneo con la del agua de mar. Quinton
          diluyó el agua marina para rebajar la concentración de sales y
          acercarla a la de la sangre, consiguió un plasma marino con el que
          curó a miles de personas, en una época en la que no había
          antibióticos.
        </p>
        <br />
        ...
        <ul className="listInfo">
          ...
          <li>
            Se puede utilizar como colutorio, desinfectante y cicatrizante para
            infecciones de boca. Tratamiento de gingivitis.
          </li>
          <li>
          ...
          <li>
            ...
            realizarlo se pierden sales y es importante recuperarlas para evitar
            cansancio, calambres, dolores de cabeza, etc.
          </li>
        ...
        <ul className="listInfo">
          ...
          <li>Como beneficiarse del agua de mar Dr. Héctor Bustos Serrano.</li>
        </ul>
      </div>
    </div>
  );
